...
## 다른 페이지로 가기
[➡️ 다음: 8.3.21. 레이어 모드(Legacy) - HSV 명도(HSV Value)](./08-03-21-hsv_components_layer_mode-hsv_value.md)

[⬅️ 이전: 8.3.19. 레이어 모드(Legacy) - HSV 채도(HSV Saturation)](./08-03-19-hsv_components_layer_mode-hsv_saturation.md)
