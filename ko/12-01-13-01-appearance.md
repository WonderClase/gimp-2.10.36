...
`GIMP 로고 보여주기` 체크박스로 클릭 + 드래그 + 드롭으로 이미지를 열 수 있는 공간([도구상자의 1번 공간](./12-01-13-01-appearance.md#90-03-a131))을 켜고 끌 수 있습니다.

아래 영상에서 이미지 여는 과정을 확인해 볼 수 있습니다.
...
참고로 GIMP(김프) 2.10.18 버전 이후부터 `도구 그룹` 기능이 추가되었습니다.
